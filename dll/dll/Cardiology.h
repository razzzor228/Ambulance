...
class HOSPITAL_API Cardiology: public HospitalDepartment
{
public:
	unordered_map<int, Patient> cardioPatients;
	vector<int> cardioCardNumbers;
	vector<Patient*> fullCardioList;

	//Cardiology();
	Cardiology(string path);
